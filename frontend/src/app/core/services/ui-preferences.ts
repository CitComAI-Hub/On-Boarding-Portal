...
export class UiPreferencesService {
    ...
    private readonly translations: TranslationDict = {
        ...
        es: {
            ...
            'landing.title': 'Unete a la red de confianza de tu ecosistema de datos',
            'landing.subtitle':
                'Una experiencia moderna de onboarding para validar tu organizacion, emitir credenciales verificables y participar activamente en el espacio de datos.',
            ...
            'landing.pillarTrust': 'Confianza desde el diseno',
            'landing.pillarTrustDesc':
                'Construye confianza digital interoperable con identidad basada en DID y controles de gobernanza desde el primer dia.',
            'landing.pillarCompliance': 'Preparacion para cumplimiento',
            'landing.pillarComplianceDesc':
                'Alinea tu proceso de onboarding con los requisitos politicos, legales y operativos del ecosistema.',
            'landing.pillarBusiness': 'Colaboracion mas rapida',
            'landing.pillarBusinessDesc':
                'Una vez aprobada, tu organizacion puede conectar con partners y activar oportunidades basadas en datos.',

            'landing.storyTitle': 'Por que este portal de onboarding es clave',
            'landing.storyBody':
                'Este portal es tu puerta oficial para convertirte en participante reconocido del espacio de datos. Reduce friccion, estandariza pasos y acelera tu camino hacia una colaboracion confiable.',
            'landing.storyPoint1': 'Registro seguro de identidad y metadatos de la organizacion',
            'landing.storyPoint2': 'Flujo de revision transparente para aprobar mas rapido',
            'landing.storyPoint3': 'Conexion directa con recursos del proyecto y servicios del futuro marketplace',
            ...
            'submit.notFound': 'No se encontro la solicitud {{id}}',

            'dashboard.title': 'Listado de solicitudes',
            'dashboard.subtitle': 'Gestion y seguimiento de registros de onboarding',
            'dashboard.colEmail': 'Correo electronico',
            'dashboard.colStatus': 'Estado',
            'dashboard.colCreatedAt': 'Fecha de registro',
            'dashboard.colUpdatedAt': 'Ultima actualizacion',
            'dashboard.colFiles': 'N. documentos',

            'review.back': 'Volver al paso anterior',
            'review.title': 'Revision de solicitudes',
            'review.notFoundTitle': 'No se encontro la solicitud',
            'review.notFoundBody':
            ...
            'form.headerTitle': 'Registro de organizacion',
            ...
            'form.address': 'Direccion completa',
            'form.city': 'Ciudad',
            'form.country': 'Pais',
            'form.postCode': 'Codigo postal',
            ...
            'form.invalidEmail': 'Introduce un correo valido',
            'form.invalidDid': 'Formato DID invalido. Debe seguir did:method:id (por ejemplo, did:web:example.com)',
            'form.readDocPrefix': 'Lee el siguiente',
            'form.readDocLink': 'documento',
            'form.readDocSuffix': 'y subelo firmado.',
            'form.readDocTooltip': 'Abrir acuerdo de aceptacion',
            'form.signedAgreement': 'Acuerdo de aceptacion firmado',
            'form.next': 'Siguiente',
            'form.back': 'Atras',
            'form.submit': 'Enviar solicitud',
            'form.submitSuccessTitle': 'Solicitud recibida',
            'form.submitSuccessDesc':
                'La solicitud se ha enviado correctamente para revision. Se ha mandado un correo de confirmacion a la direccion administrativa indicada. Guarda este ID para consultar el estado.',
            'form.copyLabel': 'ID de solicitud',
            'form.copyHint': 'Usa este ID para consultar el estado en la pestana de seguimiento.',
            ...
            'details.submissionDate': 'Fecha de envio',
            'details.lastUpdate': 'Ultima actualizacion',
            'details.attachedDocs': 'Documentos adjuntos',
            'details.remove': 'Eliminar',
            'details.reasonLabel': 'La solicitud requiere revision. Actualiza la informacion para resolver la incidencia.',
            'details.reasonRequired': 'El motivo es obligatorio cuando el estado requiere revision.',
            'details.reasonRevision': 'Motivo de la revision',
            'details.reasonPlaceholder': 'Indica la accion que debe realizar la entidad',
            'details.reasonHint': 'Explica por que la solicitud debe pasar a revision',
            ...
            'upload.addMore': 'Anadir mas',
            'upload.previewTooltip': 'Clic para previsualizar PDF',
            'upload.invalidType': 'El archivo {{name}} no tiene un tipo valido.',
            ...
            'pdf.openNewTab': 'Abrir en nueva pestana',
            'pdf.openNewTabAria': 'Abrir PDF en nueva pestana',
            'pdf.closeDialogAria': 'Cerrar dialogo',
            'pdf.invalid': 'No se pudo cargar el PDF o es invalido.',
        },
    };
